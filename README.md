...
- **Leader handle buttons:** left upper toggles **fine-grained control** (5:1 by default); left lower → **success**, right lower → **fail**, right upper → **discard** (force-home, no save).
